...
local isActorFrameHidden = false
...
local af = Def.ActorFrame{
	...
	Name=testtt
        ...
        if NumPlayers == 2 and player == PLAYER_2 then self:x(-101) end
    end,
...
local function ToggleActorFrameVisibility()
    isActorFrameHidden = not isActorFrameHidden
    af:visible(false)
end
...
-- Add an input handler to toggle the visibility of the actor frame
