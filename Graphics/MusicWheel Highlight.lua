...
return Def.ActorFrame{
	...
	LoadActor("WheelItems/"..style.."Wheel highlight")..{
		 OnCommand=function(self)
			self:x(-110):zoomx(1.16):zoomy(1.4):y(-6):diffuse(GetCurrentColor(true)):diffuseshift():effectcolor1(1,1,1,0.7):effectcolor2(1,1,1,0.3):effectperiod(1.0):effectoffset(0.2):effectclock("beat"):ztest(1)
		end
	},
}